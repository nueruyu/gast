...
namespace GastGame.AI.Strategic.Actions
{
    ...
    public class SelectObjectiveAction : IAction<StrategicState, AIContext<StrategicState>>
    {
        ...
        public UniTask ExecuteAsync(AIContext<StrategicState> ctx)
        {
            ...
            IGameCharacter bestTarget = null;
        ...
        private (float cost, IGameCharacter target) CalculateObjectiveCost(IGameCharacter self, IAIObjective objective)
        {
            switch (objective)
            {
        ...
        private IGameCharacter FindClosestCharacterOfType(IGameCharacter self, CharacterTypeId typeId)
        {
        ...
        private IPickup FindClosestPickupOfType(IGameCharacter self, ItemId itemId)
        {
